...
def run_aot():
    ...
    mod.archive("Assets/Resources/TaichiModules/implicit_fem.cgraph.tcm")
    print('AOT done')
...
sym_x = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'x', ndim=1, dtype=ti.types.vector(args.dim, ti.f32))
sym_v = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'v', ndim=1, dtype=ti.types.vector(args.dim, ti.f32))
sym_f = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'f', ndim=1, dtype=ti.types.vector(args.dim, ti.f32))
sym_ox = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'ox', ndim=1, dtype=ti.types.vector(args.dim, ti.f32))
sym_vertices = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'vertices', ndim=1, dtype=ti.types.vector(4, ti.i32))
sym_m = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'm', ti.f32, ndim=1)
sym_B = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'B', ndim=1, dtype=ti.types.matrix(args.dim, args.dim, ti.f32))
sym_W = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'W', ti.f32, ndim=1)
sym_c2e = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'c2e', ndim=1, dtype=ti.types.vector(6, ti.i32))
...
sym_b = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'b', ndim=1, dtype=ti.types.vector(3, ti.f32))
sym_mul_ans = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'mul_ans', ndim=1, dtype=ti.types.vector(args.dim, ti.f32))
sym_edges = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'edges', ndim=1, dtype=ti.types.vector(2, ti.i32))
sym_r0 = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'r0', ndim=1, dtype=ti.types.vector(3, ti.f32))
...
sym_p0 = ti.graph.Arg(ti.graph.ArgKind.NDARRAY, 'p0', ndim=1, dtype=ti.types.vector(3, ti.f32))
